...
const OurWorks = () => {
  return (
    <section className="karan__ourworks" id="OurWorks">
      <div className="karan__ourworks--container">
        <h2 className="karan__ourworks--title">
          Good design means good business
        </h2>
        <div className="karan__ourworks--works__container">
          <div className="karan__ourworks--works__container--image">
          ...
          <div className="karan__ourworks--works__container--link">
